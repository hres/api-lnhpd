...
namespace lnhpd
{
    ...
    public class DBConnection
    {
        ...
        private ProductDose ProductDoseFactory(OracleDataReader dr)
        {
            ...
            item.age_minimum = dr["AGE_MINIMUM"] == DBNull.Value ? 0 : Convert.ToDouble(dr["AGE_MINIMUM"]);
            item.age_maximum = dr["AGE_MAXIMUM"] == DBNull.Value ? 0 : Convert.ToDouble(dr["AGE_MAXIMUM"]);
            item.uom_type_desc_age = dr["UOM_TYPE_DESC_AGE"] == DBNull.Value ? string.Empty : dr["UOM_TYPE_DESC_AGE"].ToString().Trim();
            item.quantity_dose = dr["QUANTITY_DOSE"] == DBNull.Value ? 0 : Convert.ToDouble(dr["QUANTITY_DOSE"]);
            item.quantity_dose_minimum = dr["QUANTITY_MINIMUM_DOSE"] == DBNull.Value ? 0 : Convert.ToDouble(dr["QUANTITY_MINIMUM_DOSE"]);
            item.quantity_dose_maximum = dr["QUANTITY_MAXIMUM_DOSE"] == DBNull.Value ? 0 : Convert.ToDouble(dr["QUANTITY_MAXIMUM_DOSE"]);
            ...
            item.frequency = dr["FREQUENCY"] == DBNull.Value ? 0 : Convert.ToDouble(dr["FREQUENCY"]);
            item.frequency_minimum = dr["FREQUENCY_MINIMUM"] == DBNull.Value ? 0 : Convert.ToDouble(dr["FREQUENCY_MINIMUM"]);
            item.frequency_maximum = dr["FREQUENCY_MAXIMUM"] == DBNull.Value ? 0 : Convert.ToDouble(dr["FREQUENCY_MAXIMUM"]);
